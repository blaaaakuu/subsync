"""Runtime paths and asset endpoints.

This module used to be generated during a legacy ``setup.py`` build. Keeping a
real module in the source tree makes editable installs, test discovery, and
PEP 517 builds behave consistently.
"""
...
if sys.platform == "win32":
    ...
    configdir = os.path.join(
        os.path.expanduser("~"), "Library", "Preferences", appname
    )
    shareddir = configdir
